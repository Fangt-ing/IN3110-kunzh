...
def find_urls(html_string, base_url=None, output=None):
    ...
    Saves to (output.txt) file when output is given.
    ...
    full_url=re.findall(r'"canonical"(?:.)*?href="(https?://(?:.)*?(?="))', html_string)
...
if __name__ == "__main__":
    ...
    find_articles(FIS_Alpine_Ski_World_Cup, output="FIS_Alpine_Ski_World_Cup_wiki_articles")
